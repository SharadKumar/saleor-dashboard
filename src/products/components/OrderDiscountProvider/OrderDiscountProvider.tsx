...
export interface OrderDiscountConsumerProps {
  ...
  // order line provider ma miec te same typy - money + statusy
  orderDiscountRemoveStatus: ConfirmButtonTransitionState;
  orderDiscount?: OrderDiscountCommonInput;
...
const DiscountContext = createContext<OrderDiscountConsumerProps>({});
...
export const OrderDiscountProvider: React.FC<OrderDiscountProviderProps> = ({
  ...
  const getParsedMoneyData = ({ amount, currency }: IMoney) => ({
